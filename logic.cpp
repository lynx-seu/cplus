...
Dlx::Dlx(char **matrix, int row, int col) : pHead_ (new Node), colHeadArr_(col, 0)
	, colCount_(col, 0)
{
...
inline int Dlx::GetMinCol() const
{
	int min = 0xFFFFFF;
